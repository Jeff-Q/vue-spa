...
<el-card>
    <el-row>
     ...
     <tree-table :selection-type="false"  :expand-type="false" class="treeTable" :data="catelist" :columns="columns" show-index index-text="#" border :show-row-hover="false">
       <!-- 是否有效模板 -->
...
export default {
    ...
    methods: {
       async getCatelist() {
          const { data: { data, meta } } = await this.$http.get('categories', { params: this.querInfo })
                // console.log(data);
